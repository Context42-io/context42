...
### Changed
- Cleaner model loading output with Rich spinner instead of raw progress bars
- Silenced internal HuggingFace Hub logs and warnings (implementation detail)

### Fixed
- Removed confusing authentication warnings during first model download
- Progress bars from dependencies no longer pollute CLI output
